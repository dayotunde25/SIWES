...
<head>
    ...
    <title>Industry Supervisor Dashboard - SIWES Reporting System</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    <li class="nav-item">
                        <a class="nav-link active" href="/supervisor/industry">Dashboard</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/supervisor/pendingLogs">Pending Reviews</a>
                    </li>
                </ul>
                <div class="d-flex">
            ...
            <div class="col-md-8">
                <div class="card mb-4">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0">Industry Supervisor Dashboard</h5>
                    </div>
                    <div class="card-body">
                        <h6 class="fw-bold mb-3">Welcome to your SIWES Supervision Portal</h6>
                        <p>
                            As an Industry Supervisor, you are responsible for reviewing and approving the daily log entries
                            submitted by students under your supervision. Your feedback is crucial for their learning and development.
                        </p>
                                        ...
                                        <tbody>
                                            <?php foreach ($students as $student): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/supervisor/studentLogs/<?php echo $student['student_id']; ?>" class="btn btn-sm btn-outline-primary">
                            ...
                            <div class="mt-4">
                                        ...
                                        <tbody>
                                            <?php foreach ($pendingLogs as $log): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="/supervisor/reviewLog/<?php echo $log['log_entry_id']; ?>" class="btn btn-sm btn-primary">
                                ...
                                <?php if (count($pendingLogs) > 5): ?>
                                    <div class="text-end mt-2">
                                        <a href="/supervisor/pendingLogs" class="btn btn-outline-primary btn-sm">
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-grid gap-2">
                            <a href="/supervisor/pendingLogs" class="btn btn-outline-primary">
