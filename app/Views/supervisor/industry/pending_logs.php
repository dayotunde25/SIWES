        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="/supervisor/pendingLogs">Pending Reviews</a>
                    </li>
                </ul>
                <div class="d-flex">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="/supervisor/viewLog/<?php echo $log['log_entry_id']; ?>" class="btn btn-sm btn-outline-primary">
