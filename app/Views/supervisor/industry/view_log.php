    ...
    <div class="container mt-4">
        <div class="card">
            <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                ...
                <a href="/supervisor/industry" class="btn btn-light btn-sm">
            ...
            <div class="card-body">
                            ...
                            <?php 
                                switch ($log['status']) {
                                    ...
                                    case 'Approved by School':
                                        echo '<span class="badge bg-info">School Approved</span>';
                                        break;
                ...
                <?php if ($log['status'] === 'Approved by Industry' || $log['status'] === 'Rejected by Industry'): ?>
                    <div class="card mb-4">
                        <div class="card-header <?php echo $log['status'] === 'Approved by Industry' ? 'bg-success' : 'bg-danger'; ?> text-white">
                        ...
                        <div class="card-body">
                            ...
                            <?php if ($log['status'] === 'Approved by Industry' && !empty($log['industry_supervisor_signature_path'])): ?>
                                <div>
                ...
                <div class="d-flex justify-content-between">
                    <a href="/supervisor/industry" class="btn btn-outline-secondary">
                        <i class="bi bi-arrow-left"></i> Back to Dashboard
                    </a>
                    
                    <?php if ($log['status'] === 'Pending'): ?>
                        <a href="/supervisor/reviewLog/<?php echo $log['log_entry_id']; ?>" class="btn btn-primary">
