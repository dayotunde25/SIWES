    ...
    <div class="container mt-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="/supervisor/reviewLog/<?php echo $log['log_entry_id']; ?>" method="post">
                    <div class="mb-3">
                        ...
                        <?php endif; ?>
                        <div class="form-text">Provide constructive feedback on the student's activities and learnings.</div>
                    </div>
